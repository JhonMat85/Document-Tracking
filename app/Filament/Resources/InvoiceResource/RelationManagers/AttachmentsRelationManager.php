...
class AttachmentsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = '📎 Documentos de la Factura';
        ...
        return $table
            ...
            ->recordActions([
                Action::make('download')
                    ...
                    ->openUrlInNewTab()
                    ->tooltip('Descargar archivo de la factura'),
                    
                DeleteAction::make()
                    ->label('🗑️ Eliminar')
                    ->color('danger')
                    ->requiresConfirmation()
                    ->modalHeading('⚠️ Eliminar archivo de la factura')
                    ->modalDescription('¿Estás seguro de que quieres eliminar este archivo de la factura? Esta acción no se puede deshacer.')
            ...
            ->emptyStateDescription('Los archivos subidos en el formulario de la factura aparecerán aquí.')
